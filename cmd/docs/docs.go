                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.APITokenResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateAPITokenRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.CreateAPITokenResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.CreateAPITokenResponse": {
            ...
            "properties": {
                ...
                "token": {
                    "description": "Only shown once when created",
                    "type": "string"
                }
            }
        },
        ...
        "handlers.APIErrorResponse": {
            "description": "Generic error response containing a message describing the error This is used for all error responses in the API",
            "type": "object",
            "properties": {
                "message": {
